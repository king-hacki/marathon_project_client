...
import {addTask} from "../../actions/TaskAction.js"
...
class TaskAdd extends Component {
    ...
    onSubmit = () => this.props.addTask(
        this.state.title, this.state.taskDescription, this.state.statusName, this.props.match.params.sprintId)
            ...
            <Segment>
                <Container>
                    <Form>
                        ...
                        <Button
                            as={Link}
                            to={`/task/${this.props.match.params.sprintId}`}
