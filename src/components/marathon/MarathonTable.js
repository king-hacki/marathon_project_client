...
import {getListOfMarathons, deleteMarathon} from "../../actions/MarathonAction.js"
        ...
        return (
            this.props.marathons.map(marathon => (
                <Table.Row key={marathon.id}>
                    ...
                    <Table.Cell collapsing={true}>
                        <Button as={Link} to={`/user/marathon/${marathon.id}`}>Go To Users</Button></Table.Cell>
                    <Table.Cell collapsing={true}>
                        <Button as={Link} to={`/marathon/user/add/${marathon.id}`}>Add User</Button>
